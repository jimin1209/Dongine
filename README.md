...
| **데모(시제품 시연)** | Debug 빌드·시드 UI로 시나리오 가능 | [release-checklist.md](./doc/release-checklist.md) §0~§6, smoke·워크스루(표 1~9) | [doc/demo-smoke-push-map-calendar.md](./doc/demo-smoke-push-map-calendar.md), [doc/demo-walkthrough.md](./doc/demo-walkthrough.md) |
